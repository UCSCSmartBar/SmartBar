 ...
 */
public class DrinkOrderedActivity extends Activity implements ConnectionCallbacks,
    ...
    /**
     * Checks if Uber is installed on the device; if so, open the app. If not, this method opens
     * the Google Play Store to the download Uber page.
     */
    ...
    /**
     * Checks if Lyft is installed on the device; if so, open the app. If not, this method opens
     * the Google Play Store to the download Lyft page.
     */
    ...
    /* Directs user to drink library screen */
	...
	public void onConnectionFailed(ConnectionResult result) {
		...
		if (result.getErrorCode() == ConnectionResult.API_UNAVAILABLE) {
             ...
             */
            Toast.makeText(this, "This device's current configuration may not be supported.",
    ...
    class ResetFP extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                if (json == null){
                	Toast.makeText(DrinkOrderedActivity.this,
        ...
        protected void onPostExecute(String file_url) {
            if (file_url != null) {
                ...
                if (success == 1) {
                	Toast.makeText(DrinkOrderedActivity.this, file_url, Toast.LENGTH_SHORT).show();
                }
            } else {
                Toast.makeText(DrinkOrderedActivity.this,
                        "Failure to Access Server. Check Internet Connection"
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                ...
                if (success == 1) {
                    ...
                    ((MyApplication)DrinkOrderedActivity.this.getApplication()).setLoggedIn(true);
                    return json.getString(ServerAccess.TAG_MESSAGE);
                }else{
