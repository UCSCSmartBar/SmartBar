 ...
 */
public class DrinkOrderedActivity extends Activity implements ConnectionCallbacks, OnConnectionFailedListener, ResultCallback<LoadPeopleResult> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ((MyApplication)this.getApplication()).getNumber();
    ...
    class GetBAC extends AsyncTask<String, String, String> {
        ...
        protected String doInBackground(String... args) {
            ...
            try {
                // Building Parameters
                pin = ((MyApplication)DrinkOrderedActivity.this.getApplication()).getNumber();
